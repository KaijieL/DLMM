...
ResNet.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\audio_net1.pth'))
Prototype.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\audio_net2.pth'))
MLP_Classifier.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\audio_net3.pth'))
ResNet.eval()
Prototype.eval()
MLP_Classifier.eval()
...
if __name__ == "__main__":
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        np.save('C:\\Users\\98669\\Desktop\\DLMM\savefile\\audio_distance.npy',testall_img) #存为npy文件，后续利用
