...
if __name__ == "__main__":
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        #保存模型
        torch.save(ResNet.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\img_net1_%03d.pth' % (epoch + 1))
        torch.save(Prototype.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\img_net2_%03d.pth' % (epoch + 1))
        torch.save(MLP_Classifier.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\pretrain_model\\img_net3_%03d.pth' % (epoch + 1))
