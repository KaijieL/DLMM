...
if __name__ == "__main__":
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        file_list= sorted(os.listdir(dirimgfold)) #file_list是列表，列表元素是目录下所有训练数据的名称
        ...
        #保存模型
        torch.save(ResNet.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net1/img/img_net1_%03d.pth' % (epoch + 1))
        torch.save(Prototype.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net2/img/img_net2_%03d.pth' % (epoch + 1))
        torch.save(MLP_Classifier.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net3/img/img_net3_%03d.pth' % (epoch + 1))
