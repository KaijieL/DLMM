...
ResNet.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net1.pth'))
Prototype.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net2.pth'))
MLP_Classifier.load_state_dict(torch.load('C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net3.pth'))
ResNet.eval()
Prototype.eval()
MLP_Classifier.eval()
...
if __name__ == "__main__":
    ...
    with torch.no_grad():           
        ...
        np.save('C:\\Users\\98669\\Desktop\\DLMM\savefile\\img_retrain_distance.npy',testall_img) #存为npy文件，后续利用
