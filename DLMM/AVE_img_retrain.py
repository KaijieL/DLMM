...
if __name__ == "__main__":
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        dirimgfold2 = 'G:\\av_newdataset\\test_img2' #训练集所在的目录
        ...
        for element in union_all:
            ...
            retrain_imgloss.append(float(element[-1]))       #对模态课程学习排序用
        ...
        percent = min( int ( epoch / 5 + 1) * 0.1, 1 ) #每5个epoch增加20%的样本，由易到难课程学习
        ...
        #保存模型
        torch.save(ResNet.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net1_%03d.pth' % (epoch + 1))
        torch.save(Prototype.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net2_%03d.pth' % (epoch + 1))
        torch.save(MLP_Classifier.state_dict(), 'C:\\Users\\98669\\Desktop\\DLMM\\retrain_model\\retrain_img_net3_%03d.pth' % (epoch + 1))
