...
# initNetParams(ResNet)
# initNetParams(Prototype)
# initNetParams(MLP_Classifier)
...
if __name__ == "__main__":
    ...
    for epoch in range(pre_epoch, EPOCH):
        ...
        dirimgfold = '/hdd/DLMM/dataset/AVE/train/img/'
        

        
        file_list = sorted(os.listdir(dirimgfold)) #file_list是列表，列表元素是目录下所有文件的路径
        ...
        torch.save(ResNet.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net1/audio/audio_net1_%03d.pth' % (epoch + 1))
        torch.save(Prototype.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net2/audio/audio_net2_%03d.pth' % (epoch + 1))
        torch.save(MLP_Classifier.state_dict(), '/hdd/DLMM/code/AVE/model/pretrain/net3/audio/audio_net3_%03d.pth' % (epoch + 1))
